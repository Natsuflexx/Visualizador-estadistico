...
export class ChartsComponent {
  ...
  chartBarData = {
    labels: [...this.years].slice(0, 5),
    datasets: [
      {
        label: 'Hogares Censales',
        backgroundColor: '#f87979',
        data: [22268916, 24803625, 28159373, 31949709, 35219141]
      },
      {
        label:'Poblacion en Hogares Censales',
        backgroundColor: '#f56231',
        data: [95380242, 100221103, 110610075, 119530753, 125514839]
      }
    ]
  };
